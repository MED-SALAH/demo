...
from categorisation_mvt.train.outil import typecolumns

class ProcessCategorisation(Scoringfactory):
    ...
    def get_score_name(cls):
        return "cetegorisation-Mvt"

    @classmethod
    def get_example(self):
        #example for score client with api
        return  [{"credit": "", "debit": -13.99, "id_operation": 199, "lib_transaction": "PRLV SEPA SPB DEB-SPB-876-20181228-000026657097 ASSURANCE MOBILE SPB BOUYGUES TELECOM", "lib_categorie": "UNKNOWN"}]
